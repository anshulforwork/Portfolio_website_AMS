...
var typed = new Typed(".typing-text", {
  strings: [
    ...
    "Firmware development STM32,ESP32,ARDUINO",
    "PCB designing Altium kicad",
    "Hardware Integration",
    "Systems Designing -RTOS,State Machines",
    "IoT Solutions with MQTT,NodeRED ,Mosquitto",
    "Real-Time Data Processing with CAN",
  ],
  loop: true,
  typeSpeed: 50,
  backSpeed: 25,
